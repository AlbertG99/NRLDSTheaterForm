...
//	    System.exit(0);
  ...
  public static void runProgram() throws JSONException, ParseException, InterruptedException, IOException {
    ...
    Date lastRehearsalDate = new Date(dressRehearsalDate.getTime() - 2L);
    ...
    for (int i = 0; i < 2; i++) {
      ...
      saveQuestionProps("text", "<p>In addition, every actor will have a dress rehearsal on stage on Saturday, " + dateToFullWords(dressRehearsal) + ".</p>", form, formID, 410L);
